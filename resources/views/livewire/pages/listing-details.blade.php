        ...
        <div class="news-slider-container swiper-container relative">
            ...
            <div class="swiper product-details-slider static">
                <div class="swiper-wrapper mb-10">
                    ...
                    <div class="swiper-slide cursor-default">
                        <a
                            href="{{ asset('assets/img/img-slide/32.jpg') }}"
                            class="glightbox overflow-hidden"
                            data-width="118vh"
                        ><img
                                class="hover:scale-110 transition-all duration-700"
                                src="{{ asset('assets/img/img-slide/32.jpg') }}"
                                alt=""
                            ></a>
                    </div>
                    ...
                    <div class="swiper-slide cursor-default">
                        <a
                            href="{{ asset('assets/img/img-slide/33.jpg') }}"
                            class="glightbox overflow-hidden"
                            data-width="118vh"
                        ><img
                                class="hover:scale-110 transition-all duration-700"
                                src="{{ asset('assets/img/img-slide/33.jpg') }}"
                                alt=""
                            ></a>
                    </div>
                    ...
                    <div class="swiper-slide cursor-default">
                        <a
                            href="{{ asset('assets/img/img-slide/34.jpg') }}"
                            class="glightbox overflow-hidden"
                            data-width="118vh"
                        ><img
                                class="hover:scale-110 transition-all duration-700"
                                src="{{ asset('assets/img/img-slide/34.jpg') }}"
                                alt=""
                            ></a>
                    </div>
                    ...
                    <div class="swiper-slide cursor-default">
                        <a
                            href="{{ asset('assets/img/img-slide/35.jpg') }}"
                            class="glightbox overflow-hidden"
                            data-width="118vh"
                        ><img
                                class="hover:scale-110 transition-all duration-700"
                                src="{{ asset('assets/img/img-slide/35.jpg') }}"
                                alt=""
                            ></a>
                    </div>
                </div>
                ...
                <div class="lg:col-start-1 lg:col-span-8">
                  ...
                  >
                      ...
                      >
                        ...
                        <!-- Customer Reviews -->
                        @if ($property)
                            {{-- এখন আমরা নিশ্চিত যে $property ভেরিয়েবলের মান আছে --}}
                            <div class="mt-8 border-t pt-8">
                                <h2 class="text-2xl font-bold tracking-tight text-gray-900">Customer Reviews</h2>

                                <div class="flex items-center mt-4">
                                    {{-- গড় রেটিং প্রদর্শনের জন্য স্টার আইকনগুলো এখানে যুক্ত করতে পারেন --}}
                                    <div class="flex items-center">
                                        @if ($property->average_rating > 0)
                                            @for ($i = 1; $i <= 5; $i++)
                                                <svg class="h-5 w-5 {{ $property->average_rating >= $i ? 'text-yellow-400' : 'text-gray-300' }}" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <p class="ml-2 text-gray-600">
                                        <span class="font-bold">{{ number_format($property->average_rating, 1) }}</span>
                                        ({{ $property->review_count }} {{ Str::plural('review', $property->review_count) }})
                                    </p>
                                </div>

                                {{-- শুধুমাত্র $property থাকলে এই কম্পোনেন্টটি লোড হবে --}}
