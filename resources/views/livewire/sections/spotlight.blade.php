            ...
            <div>
                <div class="mb-5">
                    <p class="text-sm md:text-15px lg:text-base text-secondary-color bg-secondary-color bg-opacity-10 capitalize mb-15px py-1px px-5 rounded-full inline-block font-semibold">
                        <span class="leading-1.3">{{ app(\App\Settings\HomepageSettings::class)->spotlight_section_title }}</span>
                    </p>
                ...
                <ul class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-4 pt-4">
                    @forelse($spotlightProperty->amenities as $amenity)
                        <li class="text-sm lg:text-base flex items-center">
                            <i class="fi {{ $amenity->icon_class }} text-xl text-secondary-color bg-color-6 w-45px h-45px flex items-center justify-center mr-25px rounded-100%"></i>
                            <span class="leading-1.8" title="{{ $amenity->pivot->details }}">{{ $amenity->name }}</span>
                        </li>
                    @empty
                        <li class="text-sm lg:text-base flex items-center">
