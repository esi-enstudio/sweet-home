        ...
        <div class="hero hero-primary overflow-hidden relative z-0">
            <div class="swiper primary-slider">
                <div class="swiper-wrapper">
                    <div
                        class="swiper-slide relative z-0 pt-300px md:pt-50 pb-100px min-h-[400px] lg:min-h-[550px] xl:min-h-0 4xl:min-h-[800px] xl:h-screen h-auto overflow-hidden flex flex-col justify-center"
                    >
                        <video
                            autoplay=""
                            muted=""
                            loop=""
                            id="myVideo"
                            class="w-screen max-w-full h-full absolute left-0 top-0 -z-1 object-cover"
                        >
                            <source src="{{ asset('assets/media/3.mp4') }}" type="video/mp4" >
                        </video>
                        <div class="container w-[880px] relative z-xl">
                            <div class="">
                                <!-- banner Left -->
                                ...
                                >
                                    <p
                                        class="text-sm md:text-15px lg:text-base font-bold mb-15px text-white animated"
                                    >
                                        <i class="fas fa-home text-secondary-color"></i>
                                        Real Estate Agency
                                    </p>
                                    <h1
                                        class="text-3xl md:text-40px lg:text-6xl xl:text-50px 4xl:text-90px text-white font-bold mb-5 animated uppercase hyphens-none"
                                    >
                        <span
                            class="leading-1 md:leading-1 lg:leading-1 xl:leading-1 4xl:leading-1"
                        >
                          Find Your Dream
                          <br class="hidden md:block leading-[0]" >
                          House By Us
                        </span>
                                    </h1>
                                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-30px">
                ...
                <div>
                  ...
                  >Over 39,000 people work for us in more than 70 countries
                    all over the breadth of global coverage, combined with
                  ...
                  ></span>
                    ...
                    <div>
                        <ul class="flex gap-15px pt-4">
                            ...
                            <li>
                                <a class="glightbox2" href="assets/img/img-slide/12.jpg') }}"
                                ><img src="{{ asset('assets/img/img-slide/12.jpg') }}" alt=""
                                    ></a>
                            </li>
                            <li>
                                <a class="glightbox2" href="assets/img/img-slide/13.jpg') }}"
                            ...
                            <div class="swiper-slide mb-65px px-15px">
                                <div class="group border border-border-color-13 shadow-box-shadow-4">
                                    ...
                                    <div class="relative leading-1">
                                        ...
                                        >
                                            <img
                                                src="{{ asset('storage/' . $property->media->thumbnail) }}"
                                                ...
                                                <ul class="flex gap-10px">
                                                    <li>
                                                        <a class="w-30px lg:w-42px h-30px flex justify-center items-center bg-transparent lg:bg-white lg:bg-opacity-35 hover:text-secondary-color"
                                                            ...
                                                            {{ count($property->media->gallery) }}
                                                        </a>
                                                    </li>
                                                    <li>
                                                        @if($property->media?->video_url)
                                                        <a class="w-30px lg:w-42px h-30px flex justify-center items-center bg-transparent lg:bg-white lg:bg-opacity-35 hover:text-secondary-color"
                                                            href="{{ route('listing.details', $property->id) }}">
                                        ...
                                        <div class="text-xs sm:text-13px text-white px-10px py-1 sm:px-15px sm:pt-3px sm:pb-0 bg-green uppercase font-semibold absolute top-[15px] right-[18px]">
                                    ...
                                    <div class="px-5 pt-4 lg:px-30px lg:pt-5">
                                        ...
                                        >
                                            <span class="leading-1.8">&#x09F3; {{ number_format($property->rentAndAdditionalCost->rent) ?? 'Not set' }}</span>
                                        ...
                                        <h4 class="text-lg md:text-xl lg:text-22px font-semibold text-heading-color mb-15px">
                                            <a href="{{ route('listing.details', $property->id) }}" class="hover:text-secondary-color leading-1.3">
                                                {{ \Illuminate\Support\Str::limit($property->title, 27) }}
                                            </a>
                                        </h4>
                                        ...
                                        <ul class="flex flex-wrap gap-15px py-4">
                                            ...
                                            >
                                                <p class="leading-1.8 font-bold">
                                                    {{ $property->attached_bathroom + $property->shared_bathroom }}<i class="flaticon-clean ml-1"></i>
                                                </p>
                                            ...
                                            <li class="text-sm">
                                                <p class="leading-1.8 font-bold">
                                                    {{ $property->total_area }}<i class="flaticon-square-shape-design-interface-tool-symbol ml-1"></i>
                                                </p>
                                                <p class="leading-1.8">square Ft</p>
                                            </li>
                                        </ul>
                                        ...
                                        >
                                            <div class="flex gap-x-3">
                                                <a href="#" class="w-10 h-10">
                                                    <img
                                                        src="{{ asset('storage/' . $property->user->avatar_url) }}"
                                                        alt=""
                                                ...
                                                <div>
                                                    ...
                                                    @php
                                                        $arr = explode('_', $property->user->roles->first()?->name);
                                                        $role = \Illuminate\Support\Str::title(implode(' ', $arr));
                                                    @endphp
