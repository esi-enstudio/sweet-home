<div>
    <header class="absolute top-0 left-0 w-full z-xxl">
        <!-- header top -->
        <div class="bg-transparent border-b border-border-color-3">
                ...
                >
                    ...
                    >
                        <ul class="text flex items-center gap-15px pt-10px">
                            <li class="pr-7 relative group pb-10px">
                ...
                <div class="hero-slider-container swiper-container relative">
                    <div class="home-3">
                        <div>
                            <!-- Hero 1 -->
                            <div
                                class="relative z-0 pt-300px md:pt-50 pb-50px 4xl:h-screen 4xl:min-h-[800px] overflow-hidden flex flex-col justify-center bg-cover bg-center bg-no-repeat bg-[url('../img/slider/11.html')]"
                            >
                                <!-- overlay -->
                                <div
                            ...
                            @forelse($properties as $property )
                                <div class="swiper-slide mb-65px px-15px">
                                    <div class="group border border-border-color-13 shadow-box-shadow-4">
                                        ...
                                        <div class="relative leading-1">
                                            <a
                                                href="{{ route('listing.details', $property->slug) }}"
                                                class="overflow-hidden"
                                            >
                                                <img
                                        ...
                                        <div class="px-5 pt-4 lg:px-30px lg:pt-5">
                                            ...
                                            <h4 class="text-lg md:text-xl lg:text-22px font-semibold text-heading-color mb-15px">
                                                <a href="{{ route('listing.details', $property->slug) }}" class="hover:text-secondary-color leading-1.3">
