...
class DistrictSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('districts')->insert([
            ...
            ['division_id' => 1, 'name' => 'Chattogram', 'bn_name' => 'চট্টগ্রাম'],
            ...
            ['division_id' => 2, 'name' => 'Bogura', 'bn_name' => 'বগুড়া'],
            ...
            ['division_id' => 3, 'name' => 'Jashore', 'bn_name' => 'যশোর'],
            ...
            ['division_id' => 8, 'name' => 'Netrokona', 'bn_name' => 'নেত্রকোণা'],
        ]);
    }
}
